...
namespace sakura.frameviews
{
    ...
    /// <summary>
    /// Displays a list of save state files with name, date, and size.
    /// 
    /// This view is backed by a TableView and synchronizes with TorrentOperations events.
    /// </summary>
    public class SaveStateView : FrameView
    {
        /// <summary>
        ...
        /// <summary>
        /// Initialize the save state list view with the provided roms.
        /// </summary>
        /// <param name="files">List of fileinfo objects</param>
        public SaveStateView(List<FileInfo>? files)
            : base("Save States")
        {
            _stateFiles = files!;
